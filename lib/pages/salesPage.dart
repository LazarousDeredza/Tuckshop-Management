...
//                                 const Text("Customer: "),
//                                 const SizedBox(width: 20),
//                                 DropdownButtonFormField<customerDataModel>(
//                                   hint: const Text("Select Customer"),
//                                   value: selectedCustomerItem,
//                                   items: customerList.map((item) {
//                                     return DropdownMenuItem<customerDataModel>(
//                                       value: item,
...
//                                     });
//                                     salesMap["Customer_iD"] = item!.id;
//                                     salesMap["customer_name"] = item.name;
//                                   },
...
//                                 const Text("Products: "),
//                                 const SizedBox(width: 20),
//                                 DropdownButtonFormField<InventoryDataModel>(
//                                   hint: const Text("Select Product"),
//                                   value: selectedProductItem,
//                                   items: inventoryList.map((item) {
//                                     return DropdownMenuItem<InventoryDataModel>(
//                                       value: item,
//                                       child: Text("${item.name} (#ID ${item.id})"),
//                                     );
//                                   }).toList(),
...
//                                       perUnitPrice = int.parse(item!.unitPrice);
//                                       existingQuantity = int.parse(item.items);
//                                     });
//                                     salesMap["product_id"] = item!.id;
//                                     salesMap["unit_price"] = item.unitPrice;
//                                     salesMap["product_name"] = item.name;
//                                     inventoryFireId = item.firebaseId;
//                                   },
...
//                                 setState(() {
//                                   profitPerUnit = int.parse(value);
//                                   totalAmountState = ((editabeQuantity * perUnitPrice)) +
//                                       ((profitPerUnit * editabeQuantity));
//                                 });
//                               },
//                               validator: (value) {
...
//                               children: [
//                                 Text(
//                                   "Total Amount: " + totalAmountState.toString(),
//                                   style: const TextStyle(
//                                     fontWeight: FontWeight.bold,
//                                     color: Colors.red,
//                                   ),
